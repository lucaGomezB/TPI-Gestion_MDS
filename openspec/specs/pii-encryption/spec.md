...
> **Purpose**: Define the AES-256-GCM encryption layer for Personally Identifiable Information (PII) at rest. Provides core encryption functions and a transparent SQLAlchemy TypeDecorator for automatic encryption/decryption at the ORM layer.
